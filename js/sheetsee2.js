...
({
	1:[function(require,module,exports){
		if (typeof window.Sheetsee === 'undefined') 
			window.Sheetsee = {}; 
		window.Sheetsee = require('sheetsee-core'); 
		var extend = require('lodash.assign'); 
		extend(window.Sheetsee, require('sheetsee-tables'));
		module.exports = Sheetsee;},
		{"lodash.assign":3,"sheetsee-core":28,"sheetsee-tables":29}],
...
function sortNumeric(opts, sorter, sorted, tableDiv){
 ...
 if (opts.tableDiv != tableDiv) return
  ...
  var percntgReg =/^([0-9]{1,2}([\.][0-9]{1,})%?$|100([\.][0]{1,})%?)$/
  if(isNaN(a[sorter]) && isNaN(b[sorter])){
	if((typeof a[sorter]=="string") && a[sorter].search(percntgReg)==0 && b[sorter].search(percntgReg)==0){
	    exp1 = parseFloat(a[sorter].substring(0,a[sorter].length -1))
	    exp2= parseFloat(b[sorter].substring(0,b[sorter].length -1))
	...
	aSorter = parseInt(a[sorter])
	bSorter = parseInt(b[sorter])
